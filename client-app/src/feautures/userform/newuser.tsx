...
const usernameRegex: RegExp = new RegExp(/[\w\S]{1,15}/)

const nameValidator = (value: string) =>
  nameRegex.test(value) ? "" : "The name must start with a capital letter and between 2 and 25 letters";

const usernameValidator = (value: string) =>
  usernameRegex.test(value) ? "" : "The username can only contain letters, numbers and '_' and be less than 15 characters";
...
export default function NewUser()
{
    ...
    return(
      ...
      render={(formRenderProps: FormRenderProps) => (
        <FormElement style={{ maxWidth: 650, margin:"20% auto", border:"1px solid black", padding:"10px",  background:"#4b576e" }}>
